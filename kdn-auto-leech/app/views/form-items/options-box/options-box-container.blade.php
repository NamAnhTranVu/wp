...
<div class="options-box-container hidden">
    ...
    <div class="options-box">
        ...
        <div class="box-container">
            ...
            <h2 class="nav-tab-wrapper">
                {{-- DEFAULT --}}
                <a href="#" data-tab="#tab-options-box-find-replace"        class="nav-tab nav-tab-active">{{ _kdn('Find-Replace') }}</a>
                <a href="#" data-tab="#tab-options-box-general"             class="nav-tab">{{ _kdn('General') }}</a>
                <a href="#" data-tab="#tab-options-box-calculations"        class="nav-tab">{{ _kdn('Calculations') }}</a>
                <a href="#" data-tab="#tab-options-box-templates"           class="nav-tab">{{ _kdn('Templates') }}</a>

                {{-- FILE --}}
                <a href="#" data-tab="#tab-options-box-file-find-replace"   class="nav-tab">{{ _kdn('Find-Replace') }}</a>
                <a href="#" data-tab="#tab-options-box-file-operations"     class="nav-tab">{{ _kdn('File Operations') }}</a>
                <a href="#" data-tab="#tab-options-box-file-templates"      class="nav-tab">{{ _kdn('Templates') }}</a>

                {{-- NOTES --}}
                <a href="#" data-tab="#tab-options-box-notes"               class="nav-tab">{{ _kdn('Notes') }}</a>
            ...
            <div class="test-data-presenter" id="test-data-presenter">
                ...
                <div class="header">
                    ...
                    {{-- TITLE --}}
                    <div class="title">
                        <span>{{ _kdn('Current test data') }}</span>
                        <span class="count">(<span class="number">0</span>)</span>
                        <a role="button" class="invalidate hidden">{{ _kdn('Invalidate') }}</a>
                    </div>
