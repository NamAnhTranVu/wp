...
<table class="kdn-settings">
    ...
    @include('form-items.combined.short-code-buttons-with-label', [
        ...
        'buttons'   => $buttonsMain,
        'class'     => 'child-post-wc-external-product',
    ])

    {{-- PRODUCT URL --}}
    @include('form-items.combined.input-with-label', [
        'name'          => '_child_post_wc_product_url',
    ...
    {{-- BUTTON TEXT --}}
    @include('form-items.combined.input-with-label', [
        'name'          => '_child_post_wc_button_text',
        'title'         => _kdn('Button Text'),
        'info'          => _kdn("Set the button text."),
        'placeholder'   => _kdn('Buy product'),
        'class'         => 'child-post-wc-external-product button-text',
    ])

    {{-- REGULAR PRICE SELECTORS --}}
    @include('form-items.combined.multiple-selector-with-attribute', [
        'name'          => '_child_post_wc_regular_price_selectors',
    ...
    @include('form-items.combined.multiple-selector-with-attribute', [
        'name'          => '_child_post_wc_sale_price_selectors',
    ...
    @include('form-items.combined.multiple-selector-with-attribute', [
        'name'          => '_child_post_wc_file_url_selectors',
        ...
        'defaultAttr'   => 'src',
        'class'         => 'child-post-wc-download',
        'optionsBox'    => true,
    ])

    {{-- DOWNLOAD LIMIT --}}
    @include('form-items.combined.input-with-label', [
        'name'  => '_child_post_wc_download_limit',
    ...
    {{-- DOWNLOAD EXPIRY --}}
    @include('form-items.combined.input-with-label', [
        'name'  => '_child_post_wc_download_expiry',
