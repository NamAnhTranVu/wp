<table class="kdn-settings">
    ...
    @include('form-items.combined.multiple-selector-with-attribute', [
        'name'          => '_child_post_wc_purchase_note_selectors',
        ...
        'class'         => 'child-post-wc-purchase-note',
    ])

    {{-- ADD ALL FOUND PURCHASE NOTES --}}
    @include('form-items.combined.checkbox-with-label', [
        'name'  => '_child_post_wc_purchase_note_add_all_found',
    ...
    @include('form-items.combined.multiple-textarea-with-label', [
        'name'          => '_child_post_wc_custom_purchase_notes',
    ...
    @include('form-items.combined.checkbox-with-label', [
        'name'  => '_child_post_wc_always_add_custom_purchase_note',
    ...
    {{-- ENABLE REVIEWS --}}
    @include('form-items.combined.checkbox-with-label', [
        'name'  => '_child_post_wc_enable_reviews',
    ...
    @include('form-items.combined.input-with-label', [
        'name'  => '_child_post_wc_menu_order',
