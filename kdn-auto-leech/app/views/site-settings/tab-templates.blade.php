 ...
 * @return array
 */
function _kdn_prepare_find_replace_form_item_data($name) {
    return [
 ...
 * @since 1.8.0
 */
function _kdn_trans_html_element_short_code($shortCodeName, $transElement, $transElements) {
    return sprintf(
...
<table class="kdn-settings">
    ...
    {{-- POST LIST TEMPLATE --}}
    <tr id="post-template-is-list-type">
        <td>
            @include('form-items/label', [
    ...
    <tr id="post-template-save-images-as-gallery">
        <td>
            @include('form-items/label', [
    ...
    {{-- POST DIRECT FILE ITEM TEMPLATE --}}
    <tr id="post-template-save-direct-files">
        <td>
            @include('form-items/label', [
                'for'   => '_post_template_direct_file_item',
                'title' => _kdn('Direct File Item Template'),
                'info'  => _kdn('This template is used for the direct files. If you activated saving direct files and wrote some selectors for the direct file URLs, then the direct file items will be crawled. Here, you can set a template to be used for <b>each</b> direct file. You can include the entire direct files in main post template. <b>You must fill the template if you expect a direct file from the target page.</b>')
            ])
        </td>
        <td>@include('form-items/template-editor', ['name' => '_post_template_direct_file_item', 'buttons' => $buttonsDirectFile])</td>
    </tr>
    ...
    @include('form-items.combined.checkbox-with-label', [
        ...
        'info' => _kdn_trans_html_element_short_code(
    ...
    <tr>
        ...
        <td>
            @include('form-items.multiple', _kdn_prepare_find_replace_form_item_data('_post_find_replace_template'))
            @include('partials/test-result-container')
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            @include('form-items.multiple', _kdn_prepare_find_replace_form_item_data('_post_find_replace_custom_shortcodes'))
            @include('partials/test-result-container')
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            @include('form-items.multiple', _kdn_prepare_find_replace_form_item_data('_post_find_replace_title'))
            @include('partials/test-result-container')
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            @include('form-items.multiple', _kdn_prepare_find_replace_form_item_data('_post_find_replace_excerpt'))
            @include('partials/test-result-container')
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            @include('form-items.multiple', _kdn_prepare_find_replace_form_item_data('_post_find_replace_tags'))
            @include('partials/test-result-container')
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            @include('form-items.multiple', _kdn_prepare_find_replace_form_item_data('_post_find_replace_meta_keywords'))
            @include('partials/test-result-container')
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            @include('form-items.multiple', _kdn_prepare_find_replace_form_item_data('_post_find_replace_meta_description'))
            @include('partials/test-result-container')
        </td>
    </tr>
     ...
     * @since 1.6.3
     */
    do_action('kdn/view/site-settings/tab/templates', $settings, $postId);
