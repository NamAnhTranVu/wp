...
<table class="kdn-settings">
    ...
    <tr>
        <td>
            @include('form-items/label', [
                'for'   =>  '_test_url_child_post',
                'title' =>  _kdn('Test Post URL'),
                'info'  =>  _kdn('A full post URL to be used to perform the tests for post page CSS selectors.')
            ])
        </td>
        <td>@include('form-items/text', ['name' => '_test_url_child_post', 'type' => 'url'])</td>
    </tr>

    {{-- CUSTOM HEADERs --}}
    <tr id="child-post-custom-headers">
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_custom_headers',
    ...
    {{-- CUSTOM METHOD --}}
    <tr id="child-post-custom-method">
        <td>
            @include('form-items/label', [
                'for'   => '_child_post_custom_method',
        ...
        <td>
            @include('form-items/multiple', [
                ...
                'name'          => '_child_post_custom_method',
                'addKeys'       => true,
                'regex'         => true,
                'negate'        => true,
                'placeholder1'  => 'Method',
    ...
    <tbody id="child-post-ajax">
        {{-- POST AJAX URL SELECTORS --}}
        <tr id="child-post-ajax-selectors">
            <td>
                @include('form-items/label', [
                    'for'   =>  '_child_post_ajax_url_selectors',
            ...
            <td>
                @include('form-items/multiple', [
                    ...
                    'name'          => '_child_post_ajax_url_selectors',
        ...
        <tr>
            <td>
                @include('form-items/label', [
                    'for'   =>  '_child_post_custom_ajax_url',
            ...
            <td>
                @include('form-items/multiple', [
                    ...
                    'name'          => '_child_post_custom_ajax_url',
                    'addKeys'       => true,
                    'placeholder1'  => 'Method',
                    'placeholder2'  => 'URL'
                ])
        ...
        <tr class="test-url-ajax">
            ...
            <td>
                @include('form-items/text', [
                    'name'          => '_test_url_child_post_ajax_parse',
                    'type'          => 'text',
                    'placeholder'   => 'Started parameter'
                ])
                @include('form-items/text', [
                    'name'          => '_test_url_child_post_ajax_method',
                    'type'          => 'text',
                    'placeholder'   => 'Method'
                ])
                @include('form-items/text', [
                    'name'          => '_test_url_child_post_ajax',
                    'type'          => 'url',
                    'placeholder'   => 'URL'
                ])
            </td>
        ...
        <tr id="child-post-ajax-headers-selectors">
            <td>
                @include('form-items/label', [
                    'for'   =>  '_child_post_ajax_headers_selectors',
            ...
            <td>
                @include('form-items/multiple', [
                    ...
                    'name'          =>  '_child_post_ajax_headers_selectors',
                    'addon'         =>  'dashicons dashicons-search',
                    'data'          =>  [
                        'urlSelector'       =>  $urlSelector,
                        'testType'          =>  \KDNAutoLeech\Test\Test::$TEST_TYPE_SELECTOR_ATTRIBUTE,
        ...
        {{-- CUSTOM HEADERs --}}
        <tr id="child-post-ajax-custom-headers">
            <td>
                @include('form-items/label', [
                    'for'   =>  '_child_post_ajax_custom_headers',
                    'title' =>  _kdn('Custom HEADERs'),
                    'info'  =>  _kdn('Customize the HEADERs which are transmitted in each URL query request by writing plain text for HEADER and Value.')
                ])
            </td>
            <td>
                @include('form-items/textarea', [
                    'name'          =>  '_child_post_ajax_parse_headers',
                    'placeholder'   =>  _kdn("Parse headers from string as:\nHeader1: Value1\nHeader2: Value2\n..."),
                    'rows'          =>  4,
                    'addonTitle'    => _kdn('Parse headers'),
                    'icon'          =>  true,
                    'buttonClass'   => 'kdn-icon child-post-ajax-parse-headers',
                    'iconClass'     => 'dashicons dashicons-networking',
                    'data'          => [
                        'parse_type'    => 'child_post_ajax'
                    ]
                ])
                @include('form-items/multiple', [
                    'include'           => 'form-items/key-value',
                    'name'              => '_child_post_ajax_custom_headers',
                    'addKeys'           => true,
                    'keyPlaceholder'    => _kdn('HEADER'),
                    'valuePlaceholder'  => _kdn('Value'),
                    'class'             => 'headers-container'
        ...
        @include('site-settings.partial.html-manipulation-inputs', [
            ...
            "keyTestUrl"                        => "_test_url_child_post_ajax",
            "keyTestFindReplace"                => "_child_post_ajax_test_find_replace_first_load",
            "keyFindReplaceRawHtml"             => "_child_post_ajax_find_replace_raw__html",
            "keyFindReplaceFirstLoad"           => "_child_post_ajax_find_replace_first__load",
            "keyFindReplaceElementAttributes"   => "_child_post_ajax_find_replace_element__attributes",
            "keyExchangeElementAttributes"      => "_child_post_ajax_exchange_element__attributes",
            "keyRemoveElementAttributes"        => "_child_post_ajax_remove_element__attributes",
            "keyFindReplaceElementHtml"         => "_child_post_ajax_find_replace_element__html"
        ])
        ...
        <tr>
            <td>
                @include('form-items/label', [
                    'for'   =>  '_child_post_ajax_unnecessary_element__selectors',
            ...
            <td>
                @include('form-items/multiple', [
                    ...
                    'name'          => '_child_post_ajax_unnecessary_element__selectors',
                    'addon'         =>  'dashicons dashicons-search',
                    'addonTitle'    =>  'test',
                    'data'          =>  [
        ...
        <tr>
            <td>
                @include('form-items/label', [
                    'for'   => '_child_post_ajax_notify_empty_value_selectors',
            ...
            <td>
                @include('form-items/multiple', [
                    'include'       => 'form-items/selector-with-attribute',
                    'name'          => '_child_post_ajax_notify_empty_value_selectors',
                    'addon'         =>  'dashicons dashicons-search',
                    'data'          =>  [
                        'urlSelector'   =>  $urlAjaxSelector,
                        'testType'      =>  \KDNAutoLeech\Test\Test::$TEST_TYPE_SELECTOR_ATTRIBUTE,
    ...
    <tr>
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_type',
                'title' =>  _kdn('Post Type'),
                'info'  =>  _kdn('Set post type for posts.')
            ])
        </td>
        <td>
            @include('form-items/select', [
                'name'      =>  '_child_post_type',
                'options'   =>  $postTypes,
            ])
        </td>
    </tr>
    ...
    <tr>
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_title_selectors',
        ...
        <td>
            @include('form-items/multiple', [
                'include'       => 'form-items/selector-with-attribute',
                'name'          => '_child_post_title_selectors',
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'urlSelector'           =>  $urlSelector,
                    'testType'              =>  \KDNAutoLeech\Test\Test::$TEST_TYPE_SELECTOR_ATTRIBUTE,
    ...
    {{-- CHILD POST EXCERPT SELECTOR --}}
    <tr>
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_excerpt_selectors',
        ...
        <td>
            @include('form-items/multiple', [
                'include'       => 'form-items/selector-with-attribute',
                'name'          => '_child_post_excerpt_selectors',
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'urlSelector'   =>  $urlSelector,
                    'testType'      =>  \KDNAutoLeech\Test\Test::$TEST_TYPE_SELECTOR_ATTRIBUTE,
    ...
    {{-- CHILD POST CONTENT SELECTORS --}}
    <tr>
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_content_selectors',
        ...
        <td>
            @include('form-items/multiple', [
                'include'       =>  'form-items/selector-with-attribute',
                'name'          =>  '_child_post_content_selectors',
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'urlSelector'   =>  $urlSelector,
                    'testType'      =>  \KDNAutoLeech\Test\Test::$TEST_TYPE_SELECTOR_ATTRIBUTE,
    ...
    {{-- CHILD POST TAG SELECTORS --}}
    <tr>
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_tag_selectors',
        ...
        <td>
            @include('form-items/multiple', [
                'include'       => 'form-items/selector-with-attribute',
                'name'          => '_child_post_tag_selectors',
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'urlSelector'   =>  $urlSelector,
                    'testType'      =>  \KDNAutoLeech\Test\Test::$TEST_TYPE_SELECTOR_ATTRIBUTE,
    ...
    @include('form-items.combined.multiple-selector-with-attribute', [
        'name'          => '_child_post_category_name_selectors',
    ...
    @include('form-items.combined.checkbox-with-label', [
        'name'  => '_child_post_category_add_all_found_category_names',
    ...
    @include('form-items.combined.multiple-text-with-label', [
        'name'          => '_child_post_category_name_separators',
    ...
    @include('form-items.combined.checkbox-with-label', [
        'name'  => '_child_post_category_add_hierarchical',
    ...
    @include('form-items.combined.checkbox-with-label', [
        'name'  => '_child_post_category_do_not_add_category_in_map',
    ...
    {{-- ADD CATEGORY FROM PARENT POST --}}
    @include('form-items.combined.checkbox-with-label', [
        'name'  => '_child_post_category_from_parent_post',
        'title' => _kdn('Add categories from parent post?'),
        'info'  => _kdn("Check this if you want to add categories from parent post. Note that categories will be appended to the categories found by CSS selectors."),
    ])

    {{-- VIEWS FOR THE CHILD POST DETAIL OPTIONS. The views are registered in BasePostDetailFactory. --}}
    {{-- {!! $postDetailSettingsViews !!} --}}
    @if (isset($settings['_child_post_type'][0]) && $settings['_child_post_type'][0] == 'product')
        @include('post-detail.woocommerce.site-settings.child-post.main')
    @endif

    {{-- SECTION: DATE --}}
    @include('partials.table-section-title', ['title' => _kdn("Date")])

    {{-- CHILD POST DATE SELECTORS. --}}
    <tr>
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_date_selectors',
        ...
        <td>
            @include('form-items/multiple', [
                'include'       => 'form-items/selector-with-attribute',
                'name'          => '_child_post_date_selectors',
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'urlSelector'           =>  $urlSelector,
    ...
    <tr>
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_test_find_replace_date',
                'title' =>  _kdn('Test Date'),
                'info'  =>  _kdn('A date to be used to perform tests for the find-replace settings for dates.')
            ])
        </td>
        <td>@include('form-items/text', ['name' => '_child_post_test_find_replace_date'])</td>
    </tr>
    ...
    <tr>
        <td>
            @include('form-items/label', [
                'for'   => '_child_post_find_replace_date',
        ...
        <td>
            @include('form-items/multiple', [
                ...
                'name'          =>  '_child_post_find_replace_date',
                'addKeys'       =>  true,
                'remove'        =>  true,
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'subjectSelector'   =>  "#_child_post_test_find_replace_date",
    ...
    <tr>
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_date_add_minutes',
        ...
        <td>@include('form-items/text', ['name' => '_child_post_date_add_minutes'])</td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <div class="inputs">
                @include('form-items/checkbox', [
                    'name'          => '_child_post_meta_keywords',
                    'dependants'    => '["#child-post-meta-keywords-as-tags"]'
                ])
            </div>
        </td>
    </tr>
    ...
    <tr id="child-post-meta-keywords-as-tags">
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_meta_keywords_as_tags',
                'class' =>  'label-meta',
        ...
        <td>
            <div class="inputs">
                @include('form-items/checkbox', [
                    'name'          => '_child_post_meta_keywords_as_tags',
                ])
            </div>
        </td>
    </tr>
    ...
    <tr>
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_meta_description',
                'class' =>  'label-meta',
        ...
        <td>
            <div class="inputs">
                @include('form-items/checkbox', [
                    'name'          => '_child_post_meta_description',
                ])
            </div>
        </td>
    </tr>
    ...
    <tr>
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_save_thumbnails_if_not_exist',
        ...
        <td>
            <div class="inputs">
                @include('form-items/checkbox', [
                    'name'          => '_child_post_save_thumbnails_if_not_exist',
                    'dependants'    => '[
                        "#child-post-thumbnail-by-first-image",
                        "#child-post-thumbnail-selectors",
                        "#child-post-default-thumbnail-id",
                        "#child-post-default-thumbnail-id-by-keywords",
                        "#child-post-thumbnail-test-url",
                        "#child-post-thumbnail-find-replace"
                    ]'
                ])
            </div>
        </td>
    ...
    <tr id="child-post-thumbnail-by-first-image">
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_thumbnail_by_first_image',
        ...
        <td>
            <div class="inputs">
                @include('form-items/checkbox', [
                    'name' => '_child_post_thumbnail_by_first_image'
                ])
            </div>
        </td>
    </tr>
    ...
    <tr id="child-post-thumbnail-selectors">
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_thumbnail_selectors',
                'class' =>  'label-thumbnail',
        ...
        <td>
            @include('form-items/multiple', [
                'include'       => 'form-items/selector-with-attribute',
                'name'          => '_child_post_thumbnail_selectors',
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'urlSelector'       =>  $urlSelector,
                    'urlAjaxSelector'   =>  $urlAjaxSelector,
    ...
    <tr id="child-post-default-thumbnail-id-by-keywords">
        <td>
            @include('form-items/label', [
                'for'   => '_child_post_default_thumbnail_id_by_keywords',
        ...
        <td>
            @include('form-items/multiple', [
                'include'           => 'form-items/key-value',
                'name'              => '_child_post_default_thumbnail_id_by_keywords',
                'addKeys'           => true,
    ...
    <tr id="child-post-default-thumbnail-id">
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_default_thumbnail_id',
                'class' =>  'label-thumbnail',
        ...
        <td>@include('form-items/text', ['name' => '_child_post_default_thumbnail_id', 'placeholder' => _kdn('Comma-separated IDs')])</td>
    </tr>

    {{-- TEST THUMBNAIL IMAGE URL --}}
    <tr id="child-post-thumbnail-test-url">
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_test_find_replace_thumbnail_url',
                'class' =>  'label-thumbnail',
        ...
        <td>@include('form-items/text', ['name' => '_child_post_test_find_replace_thumbnail_url'])</td>
    </tr>

    {{-- FIND AND REPLACE FOR THUMBNAIL URL --}}
    <tr id="child-post-thumbnail-find-replace">
        <td>
            @include('form-items/label', [
                'for'   => '_child_post_find_replace_thumbnail_url',
                'class' =>  'label-thumbnail',
        ...
        <td>
            @include('form-items/multiple', [
                'include'       =>  'form-items/find-replace',
                'name'          =>  '_child_post_find_replace_thumbnail_url',
                'addKeys'       =>  true,
                'remove'        =>  true,
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'subjectSelector'   =>  "#_child_post_test_find_replace_thumbnail_url",
                    'testType'          =>  \KDNAutoLeech\Test\Test::$TEST_TYPE_FIND_REPLACE,
                ],
                'test'          => true,
                'addonClasses'  => 'kdn-test-find-replace'
    ...
    <tr>
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_save_all_images_in_content',
        ...
        <td>
            <div class="inputs">
                @include('form-items/checkbox', [
                    'name' => '_child_post_save_all_images_in_content',
                ])
            </div>
        </td>
    </tr>
    ...
    <tr>
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_save_images_as_media',
                'class' =>  'label-save-images',
        ...
        <td>
            <div class="inputs">
                @include('form-items/checkbox', [
                    'name'          => '_child_post_save_images_as_media',
                    'dependants'    => '[
                        "#child-post-save-images-as-gallery",
                        "#child-post-image-selectors",
                        "#child-post-image-add-link"
                    ]'
                ])
            </div>
        </td>
    ...
    <tr id="child-post-save-images-as-gallery">
        <td colspan="2">
            ...
            <table class="kdn-settings">
                ...
                <tr>
                    <td>
                        @include('form-items/label', [
                            'for'   =>  '_child_post_save_images_as_gallery',
                            'class' =>  'label-gallery',
                    ...
                    <td>
                        <div class="inputs">
                            @include('form-items/checkbox', [
                                'name'          => '_child_post_save_images_as_gallery',
                                'dependants'    => '[
                                    "#child-post-gallery-image-selectors",
                                    "#child-post-gallery-save-as-woocommerce-gallery",
                                    "#child-post-template-save-images-as-gallery"
                                ]'
                            ])
                        </div>
                    </td>
                ...
                <tr id="child-post-gallery-image-selectors">
                    <td>
                        @include('form-items/label', [
                            'for'   =>  '_child_post_gallery_image_selectors',
                            'class' =>  'label-gallery',
                    ...
                    <td>
                        @include('form-items/multiple', [
                            'include'       => 'form-items/selector',
                            'name'          => '_child_post_gallery_image_selectors',
                            'addon'         =>  'dashicons dashicons-search',
                            'data'          =>  [
                                'urlSelector'   =>  $urlSelector,
                                'testType'      =>  \KDNAutoLeech\Test\Test::$TEST_TYPE_SELECTOR_ATTRIBUTE,
                ...
                @if(class_exists("WooCommerce"))
                    <tr id="child-post-gallery-save-as-woocommerce-gallery">
                        <td>
                            @include('form-items/label', [
                                'for'   =>  '_child_post_save_images_as_woocommerce_gallery',
                                'class' =>  'label-gallery',
                        ...
                        <td>
                            <div class="inputs">
                                @include('form-items/checkbox', [
                                    'name'          => '_child_post_save_images_as_woocommerce_gallery'
                                ])
                            </div>
                        </td>
                    </tr>
    ...
    {{-- IMAGE SELECTORS --}}
    <tr id="child-post-image-selectors">
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_image_selectors',
                'class' =>  'label-save-images',
        ...
        <td>
            @include('form-items/multiple', [
                'include'       => 'form-items/selector',
                'name'          => '_child_post_image_selectors',
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'urlSelector'   =>  $urlSelector,
                    'testType'      =>  \KDNAutoLeech\Test\Test::$TEST_TYPE_SELECTOR_ATTRIBUTE,
    ...
    {{-- TEST IMAGE URL --}}
    <tr id="child-post-image-test-url">
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_test_find_replace_image_urls',
                'class' =>  'label-save-images',
        ...
        <td>@include('form-items/text', ['name' => '_child_post_test_find_replace_image_urls'])</td>
    </tr>

    {{-- FIND AND REPLACE FOR IMAGE URLS --}}
    <tr id="child-post-image-find-replace">
        <td>
            @include('form-items/label', [
                'for'   => '_child_post_find_replace_image_urls',
                'class' =>  'label-save-images',
        ...
        <td>
            @include('form-items/multiple', [
                'include'       =>  'form-items/find-replace',
                'name'          =>  '_child_post_find_replace_image_urls',
                'addKeys'       =>  true,
                'remove'        =>  true,
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'subjectSelector'   =>  "#_child_post_test_find_replace_image_urls",
                    'testType'          =>  \KDNAutoLeech\Test\Test::$TEST_TYPE_FIND_REPLACE,
                ],
                'test'          => true,
                'addonClasses'  => 'kdn-test-find-replace'
    ...
    <tr>
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_save_direct_files',
                'class' =>  'label-thumbnail',
        ...
        <td>
            <div class="inputs">
                @include('form-items/checkbox', [
                    'name'          => '_child_post_save_direct_files',
                    'dependants'    => '[
                        "#child-post-direct-file-selectors",
                        "#child-post-template-save-direct-files"
                    ]'
                ])
            </div>
        </td>
    ...
    <tr id="child-post-direct-file-selectors">
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_direct_file_selectors',
        ...
        <td>
            @include('form-items/multiple', [
                'include'       => 'form-items/selector-with-attribute',
                'name'          => '_child_post_direct_file_selectors',
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'urlSelector'       =>  $urlSelector,
                    'urlAjaxSelector'   =>  $urlAjaxSelector,
    ...
    <tr>
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_custom_content_shortcode_selectors',
        ...
        <td>
            @include('form-items/multiple', [
                ...
                'name'          =>  '_child_post_custom_content_shortcode_selectors',
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'urlSelector'       =>  $urlSelector,
                    'urlAjaxSelector'   =>  $urlAjaxSelector,
    ...
    <tr>
        <td>
            @include('form-items/label', [
                'for'   => '_child_post_find_replace_custom_short_code',
        ...
        <td>
            @include('form-items/multiple', [
                ...
                'name'          =>  '_child_post_find_replace_custom_short_code',
                'addKeys'       =>  true,
                'remove'        =>  true,
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'urlSelector'       =>  $urlSelector,
                    'urlAjaxSelector'   =>  $urlAjaxSelector,
                    'subjectSelector'   =>  "#_child_post_test_find_replace_first_load",
                    'testType'          =>  \KDNAutoLeech\Test\Test::$TEST_TYPE_FIND_REPLACE_IN_CUSTOM_SHORT_CODE,
                    'attr'              =>  'html',
                    'requiredSelectors' =>  $urlSelector . " | #_child_post_test_find_replace_first_load", // One of them is enough
    ...
    <tr>
        ...
        <td>
            <div class="inputs">
                @include('form-items/checkbox', [
                    'name'          => '_child_post_is_list_type',
                    'dependants'    => '[
                            "#child-post-list-title-selector",
                            "#child-post-list-content-selector",
                            "#child-post-list-item-number-selectors",
                            "#child-post-list-items-start-after-selectors",
                            "#child-post-list-insert-reversed",
                            "#child-post-list-item-auto-number",
                            "#child-post-template-is-list-type"
                        ]'
                ])
            </div>
        </td>
    ...
    <tr id="child-post-list-items-start-after-selectors">
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_list_item_starts_after_selectors',
                'class' =>  'label-list',
        ...
        <td>
            @include('form-items/multiple', [
                'include'       => 'form-items/selector',
                'name'          => '_child_post_list_item_starts_after_selectors',
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'urlSelector'   =>  $urlSelector,
    ...
    <tr id="child-post-list-item-number-selectors">
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_list_item_number_selectors',
                'class' =>  'label-list',
        ...
        <td>
            @include('form-items/multiple', [
                'include'       => 'form-items/selector-with-attribute',
                'name'          => '_child_post_list_item_number_selectors',
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'urlSelector'   =>  $urlSelector,
                    'testType'      =>  \KDNAutoLeech\Test\Test::$TEST_TYPE_SELECTOR_ATTRIBUTE,
    ...
    <tr id="child-post-list-item-auto-number">
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_list_item_auto_number',
                'class' =>  'label-list',
        ...
        <td>
            <div class="inputs">
                @include('form-items/checkbox', [
                    'name'          => '_child_post_list_item_auto_number',
                ])
            </div>
        </td>
    </tr>
    ...
    <tr id="child-post-list-title-selector">
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_list_title_selectors',
                'class' =>  'label-list',
        ...
        <td>
            @include('form-items/multiple', [
                'include'       => 'form-items/selector-with-attribute',
                'name'          => '_child_post_list_title_selectors',
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'urlSelector'   =>  $urlSelector,
                    'testType'      =>  \KDNAutoLeech\Test\Test::$TEST_TYPE_SELECTOR_ATTRIBUTE,
    ...
    <tr id="child-post-list-content-selector">
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_list_content_selectors',
                'class' =>  'label-list',
        ...
        <td>
            @include('form-items/multiple', [
                'include'       =>  'form-items/selector-with-attribute',
                'name'          =>  '_child_post_list_content_selectors',
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'urlSelector'   =>  $urlSelector,
                    'testType'      =>  \KDNAutoLeech\Test\Test::$TEST_TYPE_SELECTOR_ATTRIBUTE,
    ...
    <tr id="child-post-list-insert-reversed">
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_list_insert_reversed',
                'class' =>  'label-list',
        ...
        <td>
            <div class="inputs">
                @include('form-items/checkbox', [
                    'name'          => '_child_post_list_insert_reversed',
                ])
            </div>
        </td>
    </tr>
    ...
    {{-- PAGINATE CHILD POSTS --}}
    <tr>
        <td>
            @include('form-items/label', [
                'class' =>  'label-paginate',
                'for'   =>  '_child_post_paginate',
        ...
        <td>
            <div class="inputs">
                @include('form-items/checkbox', [
                    'name'          => '_child_post_paginate',
                    'dependants'    => '[
                        "#child-post-next-page-url-selector",
                        "#child-post-all-page-urls-selectors"
                    ]'
                ])
            </div>
        </td>
    ...
    {{-- CHILD POST NEXT PAGE URL SELECTOR --}}
    <tr id="child-post-next-page-url-selector">
        <td>
            @include('form-items/label', [
                'class' =>  'label-paginate',
                'for'   =>  '_child_post_next_page_url_selectors',
        ...
        <td>
            @include('form-items/multiple', [
                'include'       => 'form-items/selector-with-attribute',
                'name'          => '_child_post_next_page_url_selectors',
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'urlSelector'           =>  $urlSelector,
                    'urlAjaxSelector'       =>  $urlAjaxSelector,
    ...
    {{-- CHILD POST ALL PAGE URLS SELECTORS --}}
    <tr id="child-post-all-page-urls-selectors">
        <td>
            @include('form-items/label', [
                'class' =>  'label-paginate',
                'for'   =>  '_child_post_next_page_all_pages_url_selectors',
        ...
        <td>
            @include('form-items/multiple', [
                'include'       => 'form-items/selector-with-attribute',
                'name'          => '_child_post_next_page_all_pages_url_selectors',
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'urlSelector'       =>  $urlSelector,
                    'urlAjaxSelector'   =>  $urlAjaxSelector,
    ...
    <tr>
        <td>
            @include('form-items/label', [
                'for'   => '_child_post_custom_meta_selectors',
        ...
        <td>
            @include('form-items/multiple', [
                ...
                'name'          => '_child_post_custom_meta_selectors',
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'urlSelector'       =>  $urlSelector,
                    'urlAjaxSelector'   =>  $urlAjaxSelector,
    ...
    <tr>
        <td>
            @include('form-items/label', [
                'for'   => '_child_post_find_replace_custom_meta',
        ...
        <td>
            @include('form-items/multiple', [
                ...
                'name'          =>  '_child_post_find_replace_custom_meta',
                'addKeys'       =>  true,
                'remove'        =>  true,
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    ...
                    'attr'              =>  'text',
                    'requiredSelectors' =>  $urlSelector . " | #_child_post_test_find_replace_first_load"
                ],
                'test'          => true,
    ...
    {{-- ADD META FROM PARENT POST --}}
    @include('form-items.combined.checkbox-with-label', [
        'name'  => '_child_post_meta_from_parent_post',
        'title' => _kdn('Add post meta from parent post?'),
        'info'  => _kdn("Check this if you want to add post meta from parent post. Note that post meta will be appended to the post meta found by CSS selectors and custom post meta."),
    ])
    ...
    <tr>
        <td>
            @include('form-items/label', [
                'for'   => '_child_post_custom_taxonomy_selectors',
        ...
        <td>
            @include('form-items/multiple', [
                ...
                'name'          => '_child_post_custom_taxonomy_selectors',
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'urlSelector'       =>  $urlSelector,
                    'urlAjaxSelector'   =>  $urlAjaxSelector,
    ...
    <tr>
        <td>
            @include('form-items/label', [
                'for'   => '_child_post_custom_taxonomy',
        ...
        <td>
            @include('form-items/multiple', [
                ...
                'name'          => '_child_post_custom_taxonomy',
                'addKeys'       => true,
            ])
            @include('partials/test-result-container')
        </td>
    ...
    {{-- ADD TAXONOMY FROM PARENT POST --}}
    @include('form-items.combined.checkbox-with-label', [
        'name'  => '_child_post_taxonomy_from_parent_post',
        'title' => _kdn('Add taxonomies from parent post?'),
        'info'  => _kdn("Check this if you want to add taxonomies from parent post. Note that taxonomies will be appended to the taxonomies found by CSS selectors and custom taxonomies."),
    ])

    {{-- MANIPULATE HTML --}}
    @include('site-settings.partial.html-manipulation-inputs', [
        "keyTestUrl"                        => "_test_url_child_post",
        "keyTestFindReplace"                => "_child_post_test_find_replace_first_load",
        "keyFindReplaceRawHtml"             => "_child_post_find_replace_raw_html",
        "keyFindReplaceFirstLoad"           => "_child_post_find_replace_first_load",
        "keyFindReplaceElementAttributes"   => "_child_post_find_replace_element_attributes",
        "keyExchangeElementAttributes"      => "_child_post_exchange_element_attributes",
        "keyRemoveElementAttributes"        => "_child_post_remove_element_attributes",
        "keyFindReplaceElementHtml"         => "_child_post_find_replace_element_html"
    ])
    ...
    <tr>
        <td>
            @include('form-items/label', [
                'for'   => '_child_post_unnecessary_element_selectors',
                'title' =>  _kdn('Unnecessary Element Selectors'),
        ...
        <td>
            @include('form-items/multiple', [
                'include'       => 'form-items/selector',
                'name'          => '_child_post_unnecessary_element_selectors',
                'addon'         =>  'dashicons dashicons-search',
                'addonTitle'    =>  'test',
                'data'          =>  [
                    'urlSelector'   =>  $urlSelector,
    ...
    <tr>
        <td>
            @include('form-items/label', [
                'for'   => '_child_post_notify_empty_value_selectors',
                'title' => _kdn('CSS selectors for empty value notification'),
                'info'  => _kdn('Write CSS selectors and their attributes you want to retrieve. If the retrieved value
                        is empty, you will be notified via email. These CSS selectors will be tried to be retrieved
                        after all replacements are applied.')
        ...
        <td>
            @include('form-items/multiple', [
                'include'       => 'form-items/selector-with-attribute',
                'name'          => '_child_post_notify_empty_value_selectors',
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'urlSelector'   =>  $urlSelector,
                    'testType'      =>  \KDNAutoLeech\Test\Test::$TEST_TYPE_SELECTOR_ATTRIBUTE,
    ...
    <tr>
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_stop_crawling_do_not_save_post',
        ...
        <td>
            <div class="inputs">
                @include('form-items/checkbox', [
                    'name' => '_child_post_stop_crawling_do_not_save_post'
                ])
            </div>
        </td>
    </tr>
    ...
    <tr id="child-post-stop-crawling-first-page">
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_stop_crawling_first_page',
        ...
        <td>
            @include('form-items/multiple', [
                ...
                'name'          =>  '_child_post_stop_crawling_first_page',
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'urlSelector'       =>  $urlSelector,
                    'testType'          =>  \KDNAutoLeech\Test\Test::$TEST_TYPE_SELECTOR_ATTRIBUTE,
    ...
    <tr>
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_stop_crawling_all_run',
        ...
        <td>
            @include('form-items/multiple', [
                'include'       =>  'form-items/selector-stop-crawling',
                'name'          =>  '_child_post_stop_crawling_all_run',
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'urlSelector'       =>  $urlSelector,
                    'urlAjaxSelector'   =>  $urlAjaxSelector,
    ...
    <tr>
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_stop_crawling_merge',
        ...
        <td>
            <div class="inputs">
                @include('form-items/checkbox', [
                    'name' => '_child_post_stop_crawling_merge'
                ])
            </div>
        </td>
    </tr>
    ...
    <tr>
        <td>
            @include('form-items/label', [
                'for'   =>  '_child_post_stop_crawling_each_run',
        ...
        <td>
            @include('form-items/multiple', [
                'include'       =>  'form-items/selector-stop-crawling',
                'name'          =>  '_child_post_stop_crawling_each_run',
                'addon'         =>  'dashicons dashicons-search',
                'data'          =>  [
                    'urlSelector'       =>  $urlSelector,
                    'urlAjaxSelector'   =>  $urlAjaxSelector,
    ...
    <tr id="child-post-stop-crawling-last-page">
        <td>
            @include('form-items/label', [
     ...
     * @since 1.6.3
     */
    do_action('kdn/view/site-settings/tab/child-post', $settings, $postId);
