...
abstract class BasePostDetailFactory {
    ...
    public function isAvailableForPost(SettingsImpl $postSettings) {
        ...
        $childPost = $this->getPostBot() ? (bool) $this->getPostBot()->getPostData()->getChildPost() : false;

        if ($this->availabilityForPost === null || $childPost)
            $this->availabilityForPost = (bool) $this->getAvailabilityForPost($postSettings);
    ...
    public function getDetailPreparer() {
        if ($this->detailPreparer === null && $this->getDetailData() && $this->getPostBot() || $this->getPostBot()->getPostData()->getChildPost()) {
    ...
    public function getDetailSaver(PostSaverData $postSaverData) {
        if ($this->detailSaver === null && $postSaverData && $this->getDetailData() || $postSaverData->getPostData()->getChildPost()) {
    ...
    public static function getFactoryInstance($factoryClass, $postBot = null) {
        ...
        if ($postBot && !$instance->getPostBot() || $postBot && $instance->getPostBot()->getPostData()->getChildPostActive()) {
