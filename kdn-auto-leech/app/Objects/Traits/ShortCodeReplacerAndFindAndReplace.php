...
trait ShortCodeReplacerAndFindAndReplace {
     ...
     * @since 1.8.0
     */
    protected function applyShortCodesAndFindReplaces($subject, &$shortCodeMap, &$findReplaces, $innerKey = null, $reverse = false) {

        if ($reverse) {
            return $this->applyFindAndReplaces($findReplaces,
                $this->replaceShortCodes($shortCodeMap, $subject, $innerKey),
                $innerKey
            );
        }
