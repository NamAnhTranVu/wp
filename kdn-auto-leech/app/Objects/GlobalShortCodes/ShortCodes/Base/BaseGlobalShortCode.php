...
namespace KDNAutoLeech\Objects\GlobalShortCodes\ShortCodes\Base;
...
abstract class BaseGlobalShortCode {
     ...
     * array is ["src" => "kdnautoleech.com", "type" => "text/javascript"], this creates a string as
     * 'src="kdnautoleech.com" type="text/javascript"'.
     *
