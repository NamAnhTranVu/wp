 ...
 *
 * @package KDNAutoLeech\objects\assetManager
 * @since   1.8.0
 */
abstract class BaseAssetManager {
     ...
     *                     is 'kdn', localization values defined in {@link getLocalizationValues()} will be available
     *                     under 'kdn' variable in the JS window. So, to define localization values, override
     ...
     * if source URL is "/wp-content/plugins/kdn-auto-leech/app/public/dist/dev-tools.js", this method will look
     * for "/wp-content/plugins/kdn-auto-leech/app/public/dist/dev-tools-dev.js" when the debug mode is enabled. The
