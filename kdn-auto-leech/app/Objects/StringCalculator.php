...
class StringCalculator {
        ...
        foreach($variables as $k => &$v) {
            if (!is_numeric($v)) {
                ...
                Informer::add(Information::fromInformationMessage(
                    ...
                    _kdn("Value") . ": {$v}" . ' - ' . sprintf(_kdn('You can try clearing thousands separators and setting decimal separator as "%1$s"'), '.'),
     ...
     * @param bool $useThousandsSeparator See {@link useThousandsSeparator}
     */
    public function setUseThousandsSeparator($useThousandsSeparator) {
